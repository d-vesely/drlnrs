...
class TrainerTD3(_TrainerBase):
    ...
    def _training_step_indirect(self, batch, step_i, gamma, print_q):
        ...
        with torch.no_grad():
            # Get next scoring vector and next q-values
        ...
        # Every second step, generate action and optimize actor
        if step_i % 2 == 0:
            ...
            # Randomly select, which actor to use for loss
    ...
    def _training_step_direct(self, batch, step_i, gamma, print_q):
        ...
        # Every second step, generate proto-action and optimize actor
        if step_i % 2 == 0:
